...
export const HdfcLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 44" height="54" aria-label="HDFC Bank">
...
export const TataLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130 48" height="54" aria-label="Tata">
...
export const RelianceLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 48" height="54" aria-label="Reliance">
...
export const InfosysLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 48" height="54" aria-label="Infosys">
...
export const WiproLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 48" height="54" aria-label="Wipro">
...
export const MahindraLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 52" height="56" aria-label="Mahindra">
...
export const LandTLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130 52" height="56" aria-label="L&T">
...
export const ItcLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 52" height="56" aria-label="ITC">
...
export const GodrejLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 48" height="54" aria-label="Godrej">
...
export const BajajLogo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 48" height="54" aria-label="Bajaj Finserv">
