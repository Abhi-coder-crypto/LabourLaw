    ...
    api.get<AboutContent>('/about')
      .then(res => {
        ...
        setData({
          ...
          coreValues:           res.coreValues           ?? EMPTY.coreValues,
          journeyMilestones:    res.journeyMilestones    ?? EMPTY.journeyMilestones,
          whyChooseItems:       res.whyChooseItems       ?? EMPTY.whyChooseItems,
          teamMembers:          res.teamMembers          ?? EMPTY.teamMembers,
        });
      })
